...
export function ShopGrid({
  ...
  return (
    <div>
      ...
      <div className="sticky top-[7.25rem] z-30 -mx-4 border-b border-line bg-bg/90 px-4 py-3 backdrop-blur-md sm:top-[61px] sm:mx-0 sm:rounded-2xl sm:border md:top-[65px]">
